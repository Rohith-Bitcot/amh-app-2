            ...
            >
              ...
              {isExpanded && (
                <div className="overflow-x-auto">
                  {/* Sub-header */}
                  <div className="grid grid-cols-6 bg-sky-50/50 min-w-[600px]">
                    {categoryHeaders.map((header) => (
                      <div
                        key={header}
                        className="px-3 sm:px-4 py-2 text-xs font-medium font-heading text-neutral-600 whitespace-nowrap"
                      >
                        {header}
                      </div>
                    ))}
                  ...
                  {district.rows.map((row, rowIdx) => (
                    <div
                      key={row.domRange}
                      className={`grid grid-cols-6 min-w-[600px] ${
                        rowIdx % 2 === 0 ? "bg-white" : "bg-sky-50/30"
                      } border-t border-neutral-100`}
                    >
                      <div className="px-3 sm:px-4 py-2.5 text-sm font-heading text-neutral-700 whitespace-nowrap">
                        {row.domRange}
                      </div>
                      <div className="px-3 sm:px-4 py-2.5 text-sm font-heading text-neutral-800">
                        {row.holdRecentApp}
                      </div>
                      <div className="px-3 sm:px-4 py-2.5 text-sm font-heading text-neutral-800">
