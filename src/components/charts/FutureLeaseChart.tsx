      ...
      <div className="flex items-center justify-end gap-5 mb-3 text-xs font-heading text-neutral-600">
        <span className="flex items-center gap-1.5">
          <span
            ...
            style={{ backgroundColor: chartTheme.colors.palette.leaseExpiration }}
          />{''}
          Lease Expiration
        </span>
        <span className="flex items-center gap-1.5">
          <span
            className="w-2.5 h-2.5 rounded-full"
            style={{ backgroundColor: chartTheme.colors.palette.upcomingDelivery }}
          />{''}
          Upcoming Delivery
        </span>
        <span className="flex items-center gap-1.5">
          <span
            className="w-2.5 h-2.5 rounded-full"
            style={{ backgroundColor: chartTheme.colors.palette.projectedAbsorption }}
          />{''}
