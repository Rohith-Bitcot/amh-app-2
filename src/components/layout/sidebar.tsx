...
export default function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-60 bg-sky-800 z-40 flex flex-col">
      {/* Logo area */}
      <div className="h-14 px-5 flex items-center bg-gradient-to-r from-sky-800 to-sky-700">
        <Image
          src="/logo.svg"
          alt="Property Pulse"
          width={95}
