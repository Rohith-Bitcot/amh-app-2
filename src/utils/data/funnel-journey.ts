...
export const leasingConversionsData = {
  headers: [
    ...
    {
      group: "App Start to Submit",
      columns: ["T7", "PW", "PY"],
      highlighted: true,
    },
    { group: "Approval", columns: ["T7", "PW", "PY"] },
    {
      group: "Approval to Lease",
      columns: ["T7", "PW", "PY"],
      highlighted: true,
    },
  ],
  rows: [
    {
      geo: "District A",
      uniqueShowing: ["10%", "8%", "11%"],
      appStartSubmit: ["10%", "10%", "10%"],
      approval: ["10%", "10%", "10%"],
      approvalToLease: ["10%", "10%", "10%"],
    },
    {
      geo: "District B",
      uniqueShowing: ["10%", "10%", "10%"],
      appStartSubmit: ["10%", "10%", "10%"],
      approval: ["10%", "10%", "8%"],
      approvalToLease: ["10%", "10%", "10%"],
    },
...
export const websiteData = [
  { category: "LYI Button", google: 2.5, meta: 3.5, tiktok: 2.45, total: 8.45 },
  { category: "Apply Now", google: 2.2, meta: 2.8, tiktok: 2.12, total: 7.12 },
  { category: "3D Tour", google: 2, meta: 2.5, tiktok: 2.55, total: 7.05 },
